...
{
	delete laberinto;
	laberinto = new Labyrinth(LABERINTO2, mSM->getRootSceneNode(), mSM, mCamNode, label, textBox, this);
}
...
void IG2App::setupScene()
{
	...
	// ----------CREACION DEL JUEGO----------//
	laberinto = new Labyrinth(LABERINTO1, nGame, mSM, mCamNode, label, textBox, this);
	...
	intro = new Intro(mSM, nIntro, mCamNode, label, textBox);
